...
<html class="no-js" lang="zxx">
  <head>
    <meta charset="utf-8">
    <title>Listed Form Elements for The STyLE CSS Framwork</title>
    <meta name="description" content="For demonstration of the STyLE CSS Framework's list form element styles.">
