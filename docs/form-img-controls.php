...
<html class="no-js" lang="zxx">
  <head>
    <meta charset="utf-8">
    <title>Image based Form Controls for The STyLE CSS Framwork</title>
    <meta name="description" content="For demonstration of the STyLE CSS Framework's image based form control styles.">
...
<?php include("inc/doc-header.php"); ?>
    <main id="main"><form action="#main" method="post">
      <h1>Image based Form Controls</h1>
