...
<html class="no-js" lang="zxx">
  <head>
    <meta charset="utf-8">
    <title>Fully Comprehensive Form Controls for The STyLE CSS Framwork</title>
    <meta name="description" content="For demonstration of the STyLE CSS Framework's form input styles.">
...
<?php include("inc/doc-header.php"); ?>
    <main id="main"><form action="#main" method="post">
      <h1>Full set of form controls & field elements (Combined)</h1>
<?php $_GET['state'] = 'new'; include("inc/field-inputs.php"); ?>
<?php $_GET['state'] = 'existing'; include("inc/field-inputs.php"); ?>
<?php $_GET['state'] = 'verifying'; include("inc/field-inputs.php"); ?>
<?php $_GET['state'] = 'verified'; include("inc/field-inputs.php"); ?>
...
<?php include("inc/web-search-inputs.php"); ?>
<?php include("inc/listed-inputs.php"); ?>
<?php include("inc/meters.php") ?>
<?php include("inc/img-inputs.php"); ?>
    </form></main>
